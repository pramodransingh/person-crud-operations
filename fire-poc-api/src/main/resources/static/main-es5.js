...
var AppComponent = /** @class */ (function () {
    function AppComponent(httpClient, dialog, personService) {
    ...
    AppComponent.prototype.addNew = function (person) {
        var _this = this;
        var dialogRef = this.dialog.open(_persons_add_add_person_component__WEBPACK_IMPORTED_MODULE_7__["AddPersonComponent"], {
            data: { person: person }
        });
    ...
    AppComponent.prototype.startEdit = function (i, id, first_name, last_name, age, favourite_color, hobby) {
        var _this = this;
        this.id = id;
        this.index = i;
        console.log(this.index);
        var dialogRef = this.dialog.open(_persons_edit_edit_person_component__WEBPACK_IMPORTED_MODULE_8__["EditPersonComponent"], {
    ...
    AppComponent.prototype.deleteItem = function (i, id) {
        var _this = this;
        this.index = i;
        this.id = id;
        var dialogRef = this.dialog.open(_persons_delete_delete_person_component__WEBPACK_IMPORTED_MODULE_9__["DeletePersonComponent"], {
            data: { id: id }
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result === 1) {
    ...
    AppComponent.prototype.loadData = function () {
        ...
        this.exampleDatabase.getAllPersons().subscribe(function (data) {
...
var AddPersonComponent = /** @class */ (function () {
    function AddPersonComponent(dialogRef, data, personService) {
    ...
    AddPersonComponent.prototype.getErrorMessage = function () {
        return this.formControl.hasError('required') ? 'Required field' : '';
    };
    AddPersonComponent.prototype.submit = function () {
    };
    AddPersonComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    AddPersonComponent.prototype.confirmAdd = function () {
        this.personService.addPerson(this.data);
    };
    AddPersonComponent.ctorParameters = function () { return [
...
var DeletePersonComponent = /** @class */ (function () {
    function DeletePersonComponent(dialogRef, data, personService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.personService = personService;
    }
    DeletePersonComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    DeletePersonComponent.prototype.confirmDelete = function () {
        this.personService.deletePerson(this.data.id);
    };
    DeletePersonComponent.ctorParameters = function () { return [
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"] },
...
var EditPersonComponent = /** @class */ (function () {
    function EditPersonComponent(dialogRef, data, personService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.personService = personService;
        this.formControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', [
    ...
    EditPersonComponent.prototype.getErrorMessage = function () {
        return this.formControl.hasError('required') ? 'Required field' :
            '';
    };
    EditPersonComponent.prototype.submit = function () {
    };
    EditPersonComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    EditPersonComponent.prototype.stopEdit = function () {
        this.personService.updatePerson(this.data);
    };
    EditPersonComponent.ctorParameters = function () { return [
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"],] }] },
        { type: _services_person_service__WEBPACK_IMPORTED_MODULE_3__["PersonService"] }
    ]; };
...
var PersonService = /** @class */ (function () {
    ...
    Object.defineProperty(PersonService.prototype, "data", {
        get: function () {
    ...
    PersonService.prototype.getpersonData = function () {
    ...
    PersonService.prototype.addPerson = function (person) {
        ...
        this.httpClient.post(this.API_URL + "/person", person).subscribe(function (data) {
            _this.personData = person;
        }, function (err) {
        });
    };
    PersonService.prototype.updatePerson = function (person) {
        var _this = this;
        person.hobby = person.hobby.toString().split(',');
        this.httpClient.post(this.API_URL + "/person/" + person.id, person).subscribe(function (data) {
            _this.personData = person;
        }, function (err) {
        });
    };
    PersonService.prototype.deletePerson = function (id) {
        console.log(id);
        this.httpClient.delete(this.API_URL + "/person/" + id).subscribe(function (err) {
        });
    };
